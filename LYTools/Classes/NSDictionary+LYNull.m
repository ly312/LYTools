...
-(NSDictionary *)lyDictionaryReplaceNullByString{
    ...
    for (NSString *key in self) {
        ...
        //判断value的类型是字典，继续调用一遍解析
            ...
            [mutDictionary setValue:[value lyDictionaryReplaceNullByString] forKey:key];
        }
        
        //判断value的类型是数组，调用数组的容错方法
        else if ([value isKindOfClass:[NSArray class]]) {
            [mutDictionary setValue:[value lyArrayReplaceNullByString] forKey:key];
        }
