...
-(NSArray *)lyArrayReplaceNullByString{
    ...
    for (int idx = 0; idx < mutArray.count; idx ++) {
        ...
        //判断value的类型是字典，调用字典的容错方法
            ...
            [mutArray replaceObjectAtIndex:idx withObject:[value lyDictionaryReplaceNullByString]];
        }
        
        //判断value的类型是数组，继续调用一遍解析
        else if ([value isKindOfClass:[NSArray class]]) {
            [mutArray replaceObjectAtIndex:idx withObject:[value lyArrayReplaceNullByString]];
        }
